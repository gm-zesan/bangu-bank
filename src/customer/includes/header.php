<?php 
    ...
    $initials = $user->getInitials($fullName);
    $balance = $user->getBalance($session->get('user'));
?>
                        ...
                        <div class="flex items-center px-2 lg:px-0">
                            <div class="hidden sm:block">
                                <div class="flex space-x-4">
                                    ...
                                    <a
                                        href="./dashboard.php"
                                        class="text-white rounded-md py-2 px-3 text-sm font-medium <?php if (basename($_SERVER['PHP_SELF']) == 'dashboard.php') echo 'bg-emerald-700'; ?>"
                                        aria-current="page">Dashboard</a>
                                    <a
                                        href="./deposit.php"
                                        class="text-white hover:bg-emerald-700 rounded-md py-2 px-3 text-sm font-medium <?php if (basename($_SERVER['PHP_SELF']) == 'deposit.php') echo 'bg-emerald-700'; ?>">Deposit</a>
                                    <a
                                        href="./withdraw.php"
                                        class="text-white hover:bg-emerald-700 rounded-md py-2 px-3 text-sm font-medium <?php if (basename($_SERVER['PHP_SELF']) == 'withdraw.php') echo 'bg-emerald-700'; ?>">Withdraw</a>
                                    <a
                                        href="./transfer.php"
                                        class="text-white hover:bg-emerald-700 rounded-md py-2 px-3 text-sm font-medium <?php if (basename($_SERVER['PHP_SELF']) == 'transfer.php') echo 'bg-emerald-700'; ?>">Transfer</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div>
                                    <button
                                        ...
                                        <span
                                            ...
                                            <span class="font-medium leading-none text-emerald-700"><?= $initials; ?></span>
                                        </span>
                                    </button>
                                </div>
